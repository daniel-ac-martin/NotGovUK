...
`'xl'`) to set the size of the label.
...
<Canvas of={Stories.WholeNumbers} />
...
<Canvas of={Stories.DecimalNumbers} />
...
<Canvas of={Stories.NoSpellcheck} />
...
<Canvas of={Stories.ErrorsWithPrefixAndSuffix} />
