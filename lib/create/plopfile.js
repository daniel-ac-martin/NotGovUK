...
export const plopFile = async (plop) => {
  ...
  plop.setGenerator('project', {
    ...
    actions: [
      ...
      {
        type: 'copy',
        destination: '.storybook/main.js',
        source: 'skel/project/.storybook/main.js'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/common/stories.ts',
        source: 'skel/project/apps/docs/src/common/stories.ts'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/common/pages/components.tsx',
        source: 'skel/project/apps/docs/src/common/pages/components.tsx'
      },
