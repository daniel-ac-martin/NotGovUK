...
export const plopFile = async (plop) => {
  ...
  plop.setGenerator('project', {
    ...
    actions: [
      ...
      {
        type: 'copy',
        destination: 'apps/storybook/src/main.ts',
        source: 'skel/project/apps/storybook/src/main.ts'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/app/stories.ts',
        source: 'skel/project/apps/docs/src/app/stories.ts'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/app/routes/components.tsx',
        source: 'skel/project/apps/docs/src/app/routes/components.tsx'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/app/routes/components.$id.tsx',
        source: 'skel/project/apps/docs/src/app/routes/components.$id.tsx'
      },
      {
        type: 'copy',
        destination: 'apps/docs/src/app/routes/components._index.tsx',
        source: 'skel/project/apps/docs/src/app/routes/components._index.tsx'
      },
