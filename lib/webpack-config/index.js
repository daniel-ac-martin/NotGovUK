...
const generateConfig = (options) => {
  ...
  const cssLoaders = [
    ...
    // Translates CSS into CommonJS
    {
      ...
      options: {
        modules: {
          // Try to mimic NextJS, where possible
          auto: true,
          mode: 'local',
          exportGlobals: false,
          namedExport: false,
          exportLocalsConvention: 'asIs',
          //localIdentName: '[hash:base64]', // NextJS uses this
          localIdentName: '[local]', // GDS compliant class names
          // exportOnlyLocals: serverMode ? true : false // This causes us to lose the styles, for some reason
