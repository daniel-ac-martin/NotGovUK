...
export const Header: FC<IHeader> = props => {
      ...
      <ul id="navigation" className="govuk-header__navigation " aria-label="Top Level Navigation">
        {navigation.map((v, i) => (
          <li key={i} className={bem('govuk-header__navigation-item', v.active ? 'active' : '')}>
            <A classBlock="govuk-header__link" href={v.href} title={v.title}>
              {v.text}
            </A>
          </li>
        ))}
  ...
  const serviceTitle = (
    <A href={props.titleHref} classBlock="govuk-header__link" classModifiers="service-name">{props.title}</A>
  );
    ...
    <header id={props.id} className={className('govuk-header', props.className)} role="banner" data-module="govuk-header">
      <div className={className(bem('govuk-header__container', props.department), bem('govuk-width-container', props.wide ? 'wide' : undefined))}>
        <div className="govuk-header__logo">
          <A href={props.logoHref} classBlock="govuk-header__link" classModifiers="homepage">
