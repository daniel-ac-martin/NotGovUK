...
<Preview withToolbar>
  <Story name="Details">
    <Details
      summary={text('href', 'Help with nationality')}
      content={text('text', 'We need to know your nationality so we can work out which elections you’re entitled to vote in. If you cannot provide your nationality, you’ll have to send copies of identity documents through the post.')}
    />
  </Story>
</Preview>
